...
class Assembly:
    ...
    def __init__(self, name = "", materials_cost_per_mm2 = None, picknplace_machine_cost = None,
        ...
        self.static = static
        #print("Dbg: Assembly Process Created.")
        if not self.assembly_fully_defined():
    ...
    def assembly_yield(self, n_chips, n_bonds, area):
        ...
        dielectric_bond_yield = 1 - self.dielectric_bond_defect_density*dielectric_bond_area
...
class Test:
    ...
    def test_machine_cost(self):
        return self.__test_machine_cost
    
    @test_machine_cost.setter
    def test_machine_cost(self, value):
        if (self.static):
            print("Error: Cannot change static testing.")
            return 1
        else:
            if type(value) == str:
                print("Error: Test machine cost must be a number.")
                return 1
            elif value < 0:
                print("Error: Test machine cost must be nonnegative.")
                return 1
            else:
                self.__test_machine_cost = value
                return 0
        
    @property
    def test_machine_lifetime(self):
        return self.__test_machine_lifetime
    
    @test_machine_lifetime.setter
    def test_machine_lifetime(self, value):
        if (self.static):
            print("Error: Cannot change static testing.")
            return 1
        else:
            if type(value) == str:
                print("Error: Test machine lifetime must be a number.")
                return 1
            elif value < 0:
                print("Error: Test machine lifetime must be nonnegative.")
                return 1
            else:
                self.__test_machine_lifetime = value
                return 0
    
    @property
    def test_machine_uptime(self):
        return self.__test_machine_uptime
    
    @test_machine_uptime.setter
    def test_machine_uptime(self, value):
        if (self.static):
            print("Error: Cannot change static testing.")
            return 1
        else:
            if type(value) == str:
                print("Error: Test machine uptime must be a number.")
                return 1
            elif value < 0 or value > 1:
                print("Error: Test machine uptime must be between 0 and 1.")
                return 1
            else:
                self.__test_machine_uptime = value
                return 0

    @property
    def test_technician_yearly_cost(self):
        return self.__test_technician_yearly_cost

    @test_technician_yearly_cost.setter
    def test_technician_yearly_cost(self, value):
        if (self.static):
            print("Error: Cannot change static testing.")
            return 1
        else:
            if type(value) == str:
                print("Error: Test technician yearly cost must be a number.")
                return 1
            elif value < 0:
                print("Error: Test technician yearly cost must be nonnegative.")
                return 1
            else:
                self.__test_technician_yearly_cost = value
                return 0
    ...
    def test_fully_defined(self) -> bool:
        if (self.name is None or self.time_per_test_cycle is None or self.samples_per_input is None or self.test_machine_cost is None or
                self.test_machine_lifetime is None or self.test_machine_uptime is None or self.test_technician_yearly_cost is None or
    ...
    def __init__(self, name = None,
                 time_per_test_cycle = None, bb_cost_per_second = None, samples_per_input = None,
                 test_machine_cost = None, test_machine_lifetime = None, test_machine_uptime = None,
                 test_technician_yearly_cost = None,
        ...
        self.test_machine_cost = test_machine_cost
        self.test_machine_lifetime = test_machine_lifetime
        self.test_machine_uptime = test_machine_uptime
        self.test_technician_yearly_cost = test_technician_yearly_cost

        self.cost_per_second = self.compute_cost_per_second()
    ...
    def compute_self_test_cost(self, chip) -> float:
        if (self.test_self == False):
            ...
            test_cost = chip.core_area*self.time_per_test_cycle*self.cost_per_second*self.compute_self_pattern_count(chip)*self.compute_self_scan_chain_length_per_mm2(chip) #Will need to add pattern count in test def.xml, and chain length parameters in sip.xml
...
#        return adjacencyMatrixList
    ...
    def get_cost(self) -> float:
        #print("My cost is " + str(self.cost))
    ...
    def get_assembly_gates_per_mm2(self) -> float:
        total_core_area = self.core_area
    ...
    def get_stacked_die_area(self) -> float:
        ...
        for chip in self.chips:
            if not chip.buried:
                stacked_die_area += self.expandedArea(chip.get_area(),self.assembly_process.die_separation/2,chip.aspect_ratio)
