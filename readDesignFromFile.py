...
def test_process_definition_list_from_file(filename):
    ...
    for test_process_def in root:
        ...
        test_process = d.Test(name = "",
                              time_per_test_cycle = 0.0, bb_cost_per_second = "", samples_per_input = 1,
                              test_machine_cost = 0.0, test_machine_lifetime = 1.0, test_machine_uptime = 0.0,
                              test_technician_yearly_cost = 0.0,
        ...
        if attributes["bb_cost_per_second"] == "":
            test_process.cost_per_second = None
        else:
            test_process.bb_cost_per_second = float(attributes["bb_cost_per_second"])

        test_process.test_machine_cost = float(attributes["test_machine_cost"])
        test_process.test_machine_lifetime = float(attributes["test_machine_lifetime"])
        test_process.test_machine_uptime = float(attributes["test_machine_uptime"])
        test_process.test_technician_yearly_cost = float(attributes["test_technician_yearly_cost"])

        if test_process.bb_cost_per_second is not None:
            test_process.cost_per_second = test_process.bb_cost_per_second
        else:
            test_process.cost_per_second = test_process.compute_cost_per_second()
